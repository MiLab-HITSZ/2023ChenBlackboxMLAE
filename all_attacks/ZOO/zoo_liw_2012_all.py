...
def l2_attack(input, target, model, targeted, use_log, use_tanh, solver, reset_adam_after_found=True, abort_early=True,
              batch_size=100, max_iter=10, const=10000000, confidence=0.0, early_stop_iters=1000, binary_search_steps=2,
...
if __name__ == '__main__':
    ...
    npy_path = './npy/liw2012/hideall/'

    if not os.path.exists(npy_path):
        os.makedirs(npy_path)

    adv_save_path = './adv_save/voc2012/mlliw/hideall/'
