...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str,
                        choices=['liw2012', 'liw2007', 'gcn2007', 'gcn2012'],
                        default='liw2012')
    parser.add_argument('--dataset', type=str,
                        choices=['voc2007','voc2012'],
                        default='voc2012')
    parser.add_argument('--attacktype', type=str,
                        choices=['hide_single'  'hide_all'     'random_case'   'extreme_case'   'person_reduction'  'sheep_augmentation'],
                        default='hide_all')

    parser.add_argument('--pic448', type=str,
                     default='./QEBA_data/ori_save/voc2012/')

    parser.add_argument('--ori_img_path', type=str,
                        default='./ori_test_2012/')
    ...
    root_path = './QEBA_data/'
    print(args.model)
    print(args.attacktype)


    npy_path = os.path.join(root_path, 'npy/',args.model,args.attacktype)
    print(npy_path)
    # npy_path = './QEBA_data/npy/liw2012/hideall/'

    if not os.path.exists(npy_path):
        os.makedirs(npy_path)

    adv_save_path = os.path.join(root_path, 'adv_save/',args.dataset ,args.model, args.attacktype)
    if not os.path.exists(adv_save_path):
        os.makedirs(adv_save_path)


    ori_img_path = args.ori_img_path
    ori_448_path = args.pic448
