...
if __name__ == '__main__':
    ...
    adv_save_path = './QEBA_data/adv_save/voc2007/mlliw/hidesingle/'
    if not os.path.exists(adv_save_path):
        os.makedirs(adv_save_path)

    ori_448_path = './QEBA_data/single_ori_save/liw_voc2007/'
    if not os.path.exists(ori_448_path):
        os.makedirs(ori_448_path)

    ini_adv_path = './hidesingle/LIW_2007_adv/'

    ori_folder_path = './hidesingle/ori_2007liw/'
    ori_file_list = os.listdir(ori_folder_path)
