...
def get_args():
    ...
    parser.add_argument("--modelname", "-model", default="gcn2007", help="modelname")
...
## single##
    ...
    parser.add_argument("--ori_folder", "-ori", default="./hidesingle/ori_2007gcn/", help="ori folder")
    parser.add_argument("--ori_folder_save", "-ori_save", default="./hidesingle/448/ori_2007gcn/", help="ori folder")

###
    # parser.add_argument("--ori_folder", "-ori", default="./adv_save/gcn2007/ori/", help="ori folder")

    parser.add_argument("--output_folder", "-out", default="./adv_save/gcn2007/", help="Output folder")
