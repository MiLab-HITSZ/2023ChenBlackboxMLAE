...
## single##
    parser.add_argument("--ini_path", "-ini", default="./hidesingle/LIW_2007_adv/", help="ini_path")
    parser.add_argument("--ori_folder", "-ori", default="./hidesingle/ori_2007liw/", help="ori folder")
    parser.add_argument("--ori_folder_save", "-ori_save", default="./hidesingle/448/ori_2007liw/", help="ori folder")
