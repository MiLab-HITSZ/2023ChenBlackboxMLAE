...
def get_args():
    ...
    parser.add_argument("--modelname", "-model", default="liw2012", help="modelname")
...
## single##
    ...
    parser.add_argument("--ori_folder", "-ori", default="./hidesingle/ori_2012liw/", help="ori folder")
    parser.add_argument("--ori_folder_save", "-ori_save", default="./hidesingle/448/ori_2012liw/", help="ori folder")

###
    # parser.add_argument("--ori_folder", "-ori", default="./adv_save/gcn2007/ori/", help="ori folder")

    parser.add_argument("--output_folder", "-out", default="./adv_save/liw2012/", help="Output folder")
