...
def get_args():
    ...
    parser.add_argument("--modelname", "-model", default="gcncoco", help="modelname")
...
## single##
    ...
    parser.add_argument("--ori_folder", "-ori", default="./cocoori/", help="ori folder")
    parser.add_argument("--ori_folder_save", "-ori_save", default="./cocoori448/", help="ori folder")

###
    # parser.add_argument("--ori_folder", "-ori", default="./adv_save/gcn2007/ori/", help="ori folder")

    parser.add_argument("--output_folder", "-out", default="./adv_save/gcncoco/", help="Output folder")
