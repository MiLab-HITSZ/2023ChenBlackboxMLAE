...
if __name__ == '__main__':
    ...
    ############# ATTACK TYPE ###############################
    gen_adv_file(model, 'person_reduction', ori_img_path, npy_path)
    ...
    for num in [10000]:
        ...
        for f in adv_file_list:
            ...
            if ii>0:
                ...
                n_queries, x_adv ,flag = square_attack(model, x_test, y_target, args.eps, num,
                                                 args.p)
