...
parser.add_argument('--adv_file_path', default='../data/voc2012/files/VOC2012/classification_mlgcn_adv_hideall.csv', type=str, metavar='N',
...
def evaluate_adv_(state):
    ...
    adv_dataset = Voc2012Classification(args.data, 'mlgcn_adv_hideall', inp_name='../data/voc2012/voc_glove_word2vec.pkl')
