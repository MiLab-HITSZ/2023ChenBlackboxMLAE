...
parser.add_argument('--adv_file_path', default='../data/voc2007/files/VOC2007/classification_mlliw_adv_hideall.csv', type=str, metavar='N',
...
def gen_adv_file(model, target_type, adv_file_path):
    ...
    for i in range(len(pred)):
        if (y[i] == pred[i]).all() and np.sum(y[i]) >= 1 and count<500:
