...
parser.add_argument('--adv_method', default='ml_de5', type=str, metavar='N',
                    help='attack method: ml_cw, ml_rank1, ml_rank2, ml_deepfool, mla_lp:97')
parser.add_argument('--target_type', default='hide_all', type=str, metavar='N',
                    help='target method: hide_single')
parser.add_argument('--adv_file_path', default='../data/NUSWIDE/nus_wide_data_mlgcn_adv_hideall.csv', type=str, metavar='N',
...
def evaluate_adv(state):
    ...
    adv_dataset = NusWide(args.data, phase='mlgcn_adv_hideall',inp_name='../data/NUSWIDE/glove_word2vec.pkl') #
    adv_dataset.transform = data_transforms
    #adv_dataset.img_name_list = adv_dataset.img_name_list[0:len(adv)]#MLHA
