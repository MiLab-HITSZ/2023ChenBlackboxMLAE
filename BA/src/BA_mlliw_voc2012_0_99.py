...
parser.add_argument('--adv_file_path', default='../data/voc2012/files/VOC2012/classification_mlliw_adv_0_99_cut.csv', type=str, metavar='N',
                    help='all image names and their labels ready to attack')
parser.add_argument('--adv_save_x', default='../adv_save/mlliw/voc2012/0_99_cut', type=str, metavar='N',
...
def gen_adv_file(model, target_type, adv_file_path):
    ...
    # value is {-1,1}
    np.save('../adv_save/mlliw/voc2012/y_target_0_99_cut.npy', y_target)
    np.save('../adv_save/mlliw/voc2012/y_0_99_cut.npy', y)
...
def evaluate_adv(state):
    ...
    adv_dataset = Voc2012Classification(args.data, 'mlliw_adv_0_99_cut')
...
def main():
    ...
    adv_dataset = Voc2012Classification(args.data, 'mlliw_adv_0_99_cut') #zz注意！
    adv_dataset.transform = data_transforms
    ...
    # value is {-1,1}
    y_target = np.load('../adv_save/mlliw/voc2012/y_target_0_99_cut.npy')
    y = np.load('../adv_save/mlliw/voc2012/y_0_99_cut.npy')
