...
path = "/home/czj/jjr/simple-blackbox-attack-master/" #文件夹目录
npy= os.listdir("/home/czj/jjr/simple-blackbox-attack-master/npy") #得到文件夹下的所有文件名称
npy255= os.listdir("/home/czj/jjr/simple-blackbox-attack-master/npy255") #得到文件夹下的所有文件名称
x1 = []
x2 = []
xw= []
xr = []
...
for file in npy:  # 遍历文件夹
    if not os.path.isdir(file):  # 判断是否是文件夹，不是文件夹才打开
        test = np.load("/home/czj/jjr/simple-blackbox-attack-master/npy/" + file).reshape(-1)
...
for file in npy255:  # 遍历文件夹
    if not os.path.isdir(file):  # 判断是否是文件夹，不是文件夹才打开
        test_255 = np.load("/home/czj/jjr/simple-blackbox-attack-master/npy255/" + file).reshape(-1)
