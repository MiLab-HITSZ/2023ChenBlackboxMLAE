...
if __name__ == '__main__':
    ...
    # tmodel = foolbox.models.KerasModel(kmodel, bounds=(0, 255), preprocessing=preprocessing)
    fmodel =  ML_GCN(bounds=(0, 255))
    ...
    #print (image.shape)
    #print (label)
    src_image = load_imagenet_img('/home/czj/jjr/HSJA-master/data/voc/VOCdevkit/VOC2007/JPEGImages/000001.jpg')
    tgt_image = load_imagenet_img('/home/czj/jjr/HSJA-master/data/voc/VOCdevkit/VOC2007/JPEGImages/000002.jpg')
    #tgt_image = load_imagenet_img('../raw_data/imagenet_example/example.png')
    src_label = fmodel.test_one_hot('/home/czj/jjr/HSJA-master/data/voc/VOCdevkit/VOC2007/JPEGImages/000001.jpg')
    tgt_label = fmodel.test_one_hot('/home/czj/jjr/HSJA-master/data/voc/VOCdevkit/VOC2007/JPEGImages/000002.jpg')
