...
def attack(args, img_path,num):
	...
	image = np.concatenate([sample, np.zeros((448,8,3)), perturbed], axis = 1)
	...
	imageio.imwrite('./advs10w/ori/{n}.png'.format(n=num), image)
	imageio.imwrite('./advs10w/{m}-p.png'.format(m=num), perturbed)
